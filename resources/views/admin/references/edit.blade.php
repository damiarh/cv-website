...
<div>
    <div class="mb-6">
        <h1 class="text-3xl font-bold text-gray-800">Edit Reference</h1>
        <p class="text-gray-600 mt-1">Update reference details</p>
    </div>
        ...
        <form action="{{ route('admin.references.update', $reference) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="position" value="{{ old('position', $reference->position) }}" 
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition" 
                ...
                <div>
                    ...
                    <input type="text" name="company" value="{{ old('company', $reference->company) }}" 
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition" 
                ...
                <div>
                    ...
                    <input type="email" name="email" value="{{ old('email', $reference->email) }}" 
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition" 
