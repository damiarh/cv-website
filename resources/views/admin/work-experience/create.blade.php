...
<div>
    <div class="mb-6">
        <h1 class="text-3xl font-bold text-gray-800">Add Work Experience</h1>
        <p class="text-gray-600 mt-1">Add a new professional role</p>
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="description" rows="4" 
                              class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition" 
                              placeholder="Key responsibilities, achievements, projects...">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
